...
public class UserServiceImpl implements UserService, ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        User user1 = new User("ali", "$2a$10$cNzlM1MDnHRlA36iOo/88e035sbb.bQP4JWGKZ44GaAR9ahJx7CH.", true);
        User user2 = new User("osama", "$2a$10$cNzlM1MDnHRlA36iOo/88e035sbb.bQP4JWGKZ44GaAR9ahJx7CH.", true);
